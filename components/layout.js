        ...
        <Container justifyContent="space-between" alignItems="center">
          <Stack container direction="row" justifyContent="space-between" alignItems="center">
            <Link href="/" className={styles.title}>
              <Box style={{ textAlign: 'bottom' }}><img src="/images/svg/seven23_logo.svg" alt="Seven23 logo" /> <img src="/images/svg/seven23.svg" alt="Seven23" style={{ height: 28, marginTop: 2 }} /> <span style={{ fontSize: '1.2rem', paddingTop: 9, opacity: 0.9 }}> blog</span></Box>
            </Link>
